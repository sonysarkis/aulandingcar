...
const budgetOptions = ["$5k - $10k", "$10k - $20k", "$20k - $35k", "$35k+"];

export default function LeadForm() {
  const [selectedBudget, setSelectedBudget] = useState("$20k - $35k");
    ...
    <section id="contacto" className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
      <div className="grid gap-8 lg:grid-cols-12 lg:gap-10">
        ...
        <div className="lg:col-span-5">
          <div className="sticky top-24 rounded-[2rem] border p-8 backdrop-blur border-white/10 bg-white/5">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl text-white">
              Tu concesionario de confianza en Atlanta.
            </h2>
            <p className="mt-4 text-lg font-normal leading-8 text-neutral-300">
              En Super Motors nos dedicamos a conectar personas con el vehículo perfecto. Con años de experiencia en el mercado automotriz, ofrecemos un servicio transparente, personalizado y orientado a que cada cliente se sienta respaldado.
            </p>

            <div className="mt-8 space-y-4">
              <div className="flex items-start gap-3">
                <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl text-neutral-950 bg-lime-400">
                  <MapPin strokeWidth={1.5} className="h-5 w-5" />
                </div>
                <div>
                  <p className="text-base font-medium text-white">Ubicación</p>
                  <p className="text-sm font-medium text-neutral-400">Atlanta, Georgia — Servimos a todo el área metropolitana.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-base font-medium text-white">Llámanos</p>
                  <p className="text-sm font-medium text-neutral-400">(678) 736-8898 — Atención de lunes a sábado.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-base font-medium text-white">Escríbenos</p>
                  <p className="text-sm font-medium text-neutral-400">info@supermotors.com — Respuesta en menos de 24 horas.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className="grid gap-5 sm:grid-cols-2" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <button
                      ...
                      className={`rounded-2xl border px-4 py-3 text-sm font-medium transition ${
                        selectedBudget === option
                          ...
                          : "border-white/10 bg-white/5 hover:border-white/20 hover:bg-white/10 text-neutral-200"
                      }`}
                    >
                      {option}
                    </button>
              ...
              <div className="sm:col-span-2 flex flex-col gap-4 border-t pt-6 sm:flex-row sm:items-center sm:justify-between border-white/10">
                <p className="max-w-xl text-sm font-medium leading-6 text-neutral-400">
                  Al enviar, aceptas que nos comuniquemos contigo para brindarte información sobre nuestros vehículos.
                </p>
